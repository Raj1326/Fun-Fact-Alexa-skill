...
const quotes = ['North Korea and Cuba are the only places you canot buy Coca-Cola. ...',
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, you can ask me for a fact';
...
const FUNFactsIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'FUNFactsIntent';
    },
    handle(handlerInput) {
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'You can say give me a fact to me! How can I help?';
